<template>
    ...
    <div id='bottom-bar'>
        <button v-bind:style="{'background-color':userPrimaryColor}" ><i class='fa fa-user-plus fa-fw' aria-hidden='true'></i> <span>Add contact</span></button>
    </div>
    </div>
</template>
...
/* eslint-disable */ 
let hexColorList = ['#f0f8ff', '#faebd7', '#00ffff', '#7fffd4', '#f0ffff', '#f5f5dc', '#ffe4c4',
                ...
                '#f8f8ff', '#daa520', '#ffd700', '#808080', '#008000', '#adff2f', '#808080',
                '#f0fff0', '#ff69b4', '#cd5c5c', '#4b0082', '#fffff0', '#f0e68c', '#fff0f5',
                ...
                '#a0522d', '#c0c0c0', '#87ceeb', '#6a5acd', '#708090', '#708090', '#fffafa',
